 ...
 * return the minimum number of intervalsyou need to remove to make the rest
...
/** O(nlogn) n for iterations, log n for sort.
 * = means NO OVERLAP.
...
fun eraseOverlapIntervals(intervals: Array<IntArray>): Int {
    ...
    var res = 0
    var prevEnd = intervals.first()[1] // Always keeping track of an ending value.l
